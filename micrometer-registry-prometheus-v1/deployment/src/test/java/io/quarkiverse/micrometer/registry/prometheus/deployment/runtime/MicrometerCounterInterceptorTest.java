package io.quarkiverse.micrometer.registry.prometheus.deployment.runtime;
...
import io.quarkiverse.micrometer.registry.prometheus.deployment.test.CountedResource;
import io.quarkiverse.micrometer.registry.prometheus.deployment.test.GuardedResult;
import io.quarkiverse.micrometer.registry.prometheus.deployment.test.TestValueResolver;
import io.quarkiverse.micrometer.registry.prometheus.deployment.test.TimedResource;
...
public class MicrometerCounterInterceptorTest {
    ...
    void testCountAllMetrics_MetricsOnSuccess() {
        ...
        Counter counter = registry.get("metric.all")
                ...
                .tag("class", "io.quarkiverse.micrometer.registry.prometheus.deployment.test.CountedResource")
                .tag("extra", "tag")
