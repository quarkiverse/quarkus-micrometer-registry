package io.quarkiverse.micrometer.registry.deployment.binder;

import java.util.function.BooleanSupplier;

import jakarta.interceptor.Interceptor;

import io.quarkiverse.micrometer.registry.prometheus.binder.vertx.VertxMeterBinderRecorder;
